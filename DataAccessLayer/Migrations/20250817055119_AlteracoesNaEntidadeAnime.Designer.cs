...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250817055119_AlteracoesNaEntidadeAnime")]
    partial class AlteracoesNaEntidadeAnime
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.AnimeS.Broadcast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.AnimeS.Demographic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.AnimeS.ExplicitGenre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.AnimeS.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.AnimeS.Images", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.AnimeS.Jpg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.AnimeS.Theme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.AnimeS.Webp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.AnimeS.Broadcast", b =>
                {
                    b.HasOne("Entities.AnimeS.Anime", "Anime")
                        .WithOne("broadcast")
                        .HasForeignKey("Entities.AnimeS.Broadcast", "AnimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.AnimeS.Images", b =>
                {
                    b.HasOne("Entities.AnimeS.Anime", "Anime")
                        .WithOne("images")
                        .HasForeignKey("Entities.AnimeS.Images", "AnimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.AnimeS.Jpg", "Jpg")
                        .WithMany()
                        .HasForeignKey("JpgId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.AnimeS.Webp", "Webp")
                        .WithMany()
