...
const API_BASE_URL = 'https://localhost:7164/api/MangaComentary';

export const MangaComentaryService = {
  ...
  async getByManga(mangaId) {
    const response = await axios.get(`${API_BASE_URL}/ByManga/${mangaId}`);
    return response.data;
  },
