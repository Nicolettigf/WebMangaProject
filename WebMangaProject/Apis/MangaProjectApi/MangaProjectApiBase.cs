...
namespace MvcPresentationLayer.Apis.MangaProjectApi
{
    public abstract class MangaProjectApiBase
    {
        ...
        {
            client.BaseAddress = new Uri("https://localhost:7164/api/");   //https://animalistwebapiservice.azurewebsites.net/api/ //https://localhost:7164/api/ //https://animalistwebapiservice.azurewebsites.net/api/
